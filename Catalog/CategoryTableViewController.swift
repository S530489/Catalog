...
class CategoryTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        //return AppDelegate.myModel.findItemsInCategory(category: AppDelegate.myModel.categories[section]).count
        return AppDelegate.myModel.categories.count
    }

    
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "categoriesList", for: indexPath)
